...
from KALVANMUSIC.utils.database import group_assistant
from KALVANMUSIC.utils.admin_filters import admin_filter
...
async def vc_info(client, message: Message):
    ...
    try:
        assistant = await group_assistant(KALVAN, chat_id)
