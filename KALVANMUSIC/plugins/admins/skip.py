...
from KALVANMUSIC.utils.database import get_loop
...
from KALVANMUSIC.utils.inline.play import colored_stream_markup
...
async def skip(cli, message: Message, _, chat_id):
    ...
    if "live_" in queued:
        ...
        try:
            ...
            image = None
        try:
            await KALVAN.skip_stream(chat_id, link, video=status, image=image)
        except:
