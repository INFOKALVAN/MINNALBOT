...
from KALVANMUSIC.core.dir import COUPLE_DIR
from KALVANMUSIC.mongo.couples_db import get_couple, save_couple


ASSETS = Path("KALVANMUSIC/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "kalvan/couple.png").convert("RGBA")
