...
from KALVANMUSIC.mongo.welcomedb import is_on, bump, cool, auto_on
from KALVANMUSIC.utils.colored_buttons import styled_button, buttons_to_inline_markup

BG_PATH = "KALVANMUSIC/assets/KALVAN/welcome.png"
FALLBACK_PIC = "KALVANMUSIC/assets/upic.png"
FONT_PATH = "KALVANMUSIC/assets/KALVAN/Arimo.ttf"
...
def build_pic(av, fn, uid, un):
    ...
    # 'KALVANMUSIC/assets/kalvan/welcome.png' file.
...
async def welcome(client, update: ChatMemberUpdated):
    ...
    try:
        ...
        for f in (avatar, img):
            if f and os.path.exists(f) and "KALVANMUSIC/assets" not in f:
                try:
                    os.remove(f)
                except:
                    pass
