...
from KALVANMUSIC.utils.cookie_handler import COOKIE_PATH
from KALVANMUSIC.utils.database import is_on_off
from KALVANMUSIC.utils.downloader import download_audio_concurrent, yt_dlp_download
from KALVANMUSIC.utils.errors import capture_internal_err
from KALVANMUSIC.utils.formatters import time_to_seconds
from KALVANMUSIC.utils.tuning import (
    YTDLP_TIMEOUT,
    YOUTUBE_META_MAX,
    YOUTUBE_META_TTL,
)
from KALVANMUSIC import LOGGER
...
async def load_apis():
    ...
    logger = LOGGER("KALVANMUSIC.platforms.Youtube.py")
