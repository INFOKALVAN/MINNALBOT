...
import config
from KALVANMUSIC import LOGGER, app
from KALVANMUSIC.core.mongo import mongodb
from KALVANMUSIC.misc import db
from KALVANMUSIC.platforms.Youtube import YouTubeAPI, youtube_search_multi
...
ARTIST_LANG = {
    "hindi": [
        ...
        "kalvan shekhar", "amit trivedi", "pritam", "shankar ehsaan loy",
    ],
    "punjabi": [
...
async def auto_play_next(
    ...
    """
    from KALVANMUSIC.utils.database import get_lang
    ...
    try:
        ...
        from KALVANMUSIC.utils.database import is_active_chat as _verify_stream_active
        ...
        try:
            ...
            from KALVANMUSIC.utils.database import is_on_off
